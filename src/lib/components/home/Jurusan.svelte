...
<div class="w-full max-w-screen-lg px-4 py-8">
	<div class="flex items-center flex-col md:flex-row space-y-8 md:space-y-0 mt-4">
		...
		>
			<Swiper
				class="absolute w-full top-4 left-4 rounded-xl"
				spaceBetween={0}
				slidesPerView={1}
				loop={true}
		...
		<div class="w-full md:w-1/2 pb-3 md:mr-8 md:order-1">
			<h3 class="text-3xl font-black mb-3">Beragam Pilihan Kompetensi Keahlian</h3>
			<p class="text-lg leading-7 font-light mb-8">
				Calon peserta didik diberi banyak pilihan kometensi keahlian sehingga mereka dapat memilih
				yang sesuai dengan minat dan bakatnya. SMK Negeri 1 Seyegan memiliki jumlah total 7
				kompetensi keahlian.
			</p>
			<a
				class="text-white bg-green-500 focus:bg-green-300 shadow-xl rounded py-3 px-5"
				href="/kompetensi-keahlian">Selengkapnya</a
			>
		</div>
	</div>
</div>
